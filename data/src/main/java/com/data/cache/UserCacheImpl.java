...
public class UserCacheImpl implements UserCache {
    ...
    public void evictAll() {
        this.executeAsynchronously(new CacheEvitor(this.fileManager, this.cacheDir));
    }
     ...
     *
     */
    private static class CacheEvitor implements Runnable {
        private final FileManager fileManager;
        private final File cacheDir;

        CacheEvitor(FileManager fileManager, File cacheDir){
            this.fileManager = fileManager;
